 ...
 * La clase se creó el 07/2/2023 por Miguel Pozo.
 * Esta es la versión 2.3
 */
//Modificar.
public class EntradaBlogMPP {
/**
 ...
 */
public EntradaBlogMPP(int id, String autor, String texto)throws IllegalArgumentException{
...
public static void main(String[] args) {
        //Modificar.
        EntradaBlogMPP e1=new EntradaBlogMPP  (3,"ana","Últimas noticias, está disponible BixBy 2.0");
